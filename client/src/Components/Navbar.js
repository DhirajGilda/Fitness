    ...
    <div>
      ...
      <div  className="DESKTOP-MENU hidden lg:flex justify-between items-center mt-5 ">
        ...
        <Stack direction="row" gap={'40px'} fontSize="24px" alignItems={'flex-end'} >
          ...
          <Link to={'/exercise'} style={{textDecoration:'none'}} class='text-white'>Exercise</Link>
          <Link to={'/Meals'} style={{textDecoration:'none'}} class='text-white'>Meals</Link>
          <Link to={'/AboutUS'} style={{textDecoration:'none'}} class='text-white'>About Us</Link>
...
//           <a href='Meals' style={{textDecoration:'none'}} class='text-white'>Blog</a>
